...
// Defines the structure for a Double-Ended Queue (DEQueue).
// It's implemented using a circular array.
typedef struct {
    int data[MAX_SIZE];
    int front;
    int rear;
...
int main() {
    ...
    initializeQueue(&dq);
    printf("Hello! Here You Can Perform Following DEQueue Operation!");
    while (1) {
        printf("\n1. En-Queue Front\n2. En-Queue Rear\n3. De-Queue Front\n4. De-Queue Rear\n5. Peek Front\n6. Peek Rear\n7. Is Empty\n8. Is Full\n9. Exit\nEnter Your Choice:- ");
        scanf("%d", &choice);
